...
OAK_TEST_DECL(ParseCompoundAssign)
{
  ...
  */
  ...
  const struct
  {
    ...
    { OAK_NODE_KIND_STMT_ADD_ASSIGN, "a", 1 },
    { OAK_NODE_KIND_STMT_SUB_ASSIGN, "b", 2 },
    { OAK_NODE_KIND_STMT_MUL_ASSIGN, "c", 3 },
    { OAK_NODE_KIND_STMT_DIV_ASSIGN, "d", 4 },
    { OAK_NODE_KIND_STMT_MOD_ASSIGN, "e", 5 },
  };
