...
OAK_API const oak_module_t* oak_compiler_module_for_alias(
...
OAK_API const oak_module_export_fn_t*
...
OAK_API const oak_module_export_record_t*
...
OAK_API const oak_module_export_enum_t*
