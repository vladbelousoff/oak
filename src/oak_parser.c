...
static usize grammar_rule_count(const struct oak_grammar_entry_t* entry)
{
  usize n = 0;
                                          ...
                                          const enum oak_node_kind_t kind)
{
  ...
  const usize count = grammar_rule_count(entry);
                                           ...
                                           const enum oak_node_kind_t kind)
{
  ...
  const usize choice_count = grammar_rule_count(entry);
