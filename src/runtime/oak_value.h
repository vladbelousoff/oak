...
oak_string_concat(oak_allocator_t* a,
                  const oak_obj_string_t* s1,
                  const oak_obj_string_t* s2);
oak_obj_string_t*
oak_string_concat_in_table(oak_allocator_t* a,
                           u32 table_id,
                           const oak_obj_string_t* s1,
                           const oak_obj_string_t* s2);
...
OAK_API oak_value_t oak_map_key_at(const oak_obj_map_t* map,
                                          usize index);
OAK_API oak_value_t oak_map_value_at(const oak_obj_map_t* map,
                                            usize index);
...
OAK_API oak_obj_string_t*
oak_value_to_string(oak_allocator_t* allocator,
                    oak_value_t value);
oak_obj_string_t* oak_value_to_string_in_table(
    oak_allocator_t* allocator, u32 table_id, oak_value_t value);
...
oak_string_from_value_repr(oak_allocator_t* allocator,
                           oak_value_t value);
oak_obj_string_t* oak_string_from_value_repr_in_table(
    oak_allocator_t* allocator, u32 table_id, oak_value_t value);
